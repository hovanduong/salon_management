...
// import '../../typography/paragraph.dart';
...
class _DiaLogPhoneCustomerState extends State<DiaLogPhoneCustomer> {
  ...
  Widget build(BuildContext context) {
    ...
    // void showToast(String msg, {Color? bgColor, int? duration, int? gravity}) =>
    //     Toast.show(msg, context,
    //         backgroundColor: bgColor!, duration: duration, gravity: gravity);
    return Center(
      child: Column(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        const Icon(
                          ...
                          size: 20, color: AppColors.PRIMARY_GREEN,
                        ),
                      ],
                    ),
                  ),
