...
class SlidableActionWidget extends StatelessWidget {
  const SlidableActionWidget({
    super.key, 
    this.child,
    this.onTapButtonDelete, 
    this.onTapButtonUpdate, 
    this.isEdit=false,
  });

  final Widget? child;
  final Function(BuildContext context)? onTapButtonDelete;
  final Function(BuildContext context)? onTapButtonUpdate;
  final bool isEdit;
